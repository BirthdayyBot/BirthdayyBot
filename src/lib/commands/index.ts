...
export const CONFIG_ANNOUNCEMENT_CHANNEL = chatInputApplicationCommandMention('config', 'announcement-channel', '935174203882217483');
...
export const CONFIG_ANNOUNCEMENT_MESSAGE = chatInputApplicationCommandMention('config', 'announcement-message', '935174203882217483');
