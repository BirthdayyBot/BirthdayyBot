...
import type { Birthday } from '#root/utilities/db/Birthday';
import type { Blacklist } from '#root/utilities/db/Blacklist';
import type { Guild } from '#root/utilities/db/Guild';
import type { User } from '#root/utilities/db/User';
