 ...
 * @property {Array<APIEmbed>} [fields] - An array of fields to include in the embed
 * @property {string} [color] - The color of the embed
 *
 * @returns embed - A RichEmbed object with the given information
 */

export default function generateEmbed(embed_information: EmbedInformationModel): APIEmbed {
